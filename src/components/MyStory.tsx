...
const MyStory = () => {
  ...
  const storyMilestones = isZh
    ? [
        ...
        { id: '2023-cto-journey', year: '2023', title: 'CTO 之路：领导力、产品与 AI 转型', category: '领导力', story: '担任光荣智能 CTO，并以外部顾问身份兼任飞凡科技 CTO 与红熊AI 研发总经理。关注点从纯技术决策扩展到团队、产品、客户与 AI 落地，学习如何在复杂约束下推动可执行的创新。', lessons: ['技术负责人必须理解业务与产品', '团队建设往往比技术选型更难也更重要', 'AI 转型需要节奏感，而不是口号'] },
